  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        description:
          "Your one-stop shop for all your furniture needs. Browse our wide selection of high-quality furniture, from stylish sofas to comfortable beds. Shop now and enjoy free shipping on orders over $100.",
        theme_color: "#286F6C",
        icons: [
          {
